...
@BorshSubTypes(
    BorshSubTypes.BorshSubType(`when` = Action.CREATE_ACCOUNT.toInt(), `use` = CreateAccountAction::class),
    BorshSubTypes.BorshSubType(`when` = Action.DEPLOY_CONTRACT.toInt(), use = DeployContractAction::class),
    BorshSubTypes.BorshSubType(`when` = Action.FUNCTION_CALL.toInt(), use = FunctionCallAction::class),
    ...
    BorshSubTypes.BorshSubType(`when` = Action.DELETE_ACCOUNT.toInt(), use = DeleteAccountAction::class),
